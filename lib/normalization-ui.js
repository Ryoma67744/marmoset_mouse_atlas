...
(function (global) {
  ...
  function open(options) {
    ...
    dialog.innerHTML = '<h2 id="normalization-title" style="font-size:20px;font-weight:700">補正・正規化の設定</h2>' +
      ...
      '<p style="background:#fffbeb;padding:10px;font-size:13px">同じブラウザの Viewer は設定の更新を通知します。旧版のタブは先に再読み込みしてください。別 PC の更新は Viewer を開く・戻る際に確認します。' +
      '未保存の編集がある場合は、Viewer の案内を確認してください。' +
