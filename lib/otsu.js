...
(function (global) {
  ...
  function isInternalStandard(molecule, key, profile) {
    ...
    if (molecule.isInternalStandard === true || molecule.internalStandard === true || molecule.isIsotope === true ||
    ...
    return /(^|[^a-z0-9])d\d+(?=$|[^a-z0-9]|5ht|5-ht|da|ne|serotonin)/.test(name) ||
      /(^|[^a-z0-9])(13c\d*|15n\d*|17o\d*|18o\d*|33s\d*|34s\d*|2h\d*|c13|n15|o17|o18|s33|s34)(?=$|[^a-z0-9])/.test(name) ||
  ...
  global.Otsu = { NBINS: OTSU_NBINS, computeOtsuThreshold, buildOtsuRecord, buildTic, buildProjectRecord, isInternalStandard, reasonText, REASONS };
})(window);
