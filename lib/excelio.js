...
(function (global) {
  ...
  function buildIndexXlsx(records, metadata) {
    ...
    rows.push([], [
      ...
      'Data rows', 'Molecules', 'ROIs', 'Data sheets', 'Warnings', 'Error',
    ]);
    normalized.forEach(record => rows.push([
      ...
      record.roiCount, record.dataSheetCount, record.warnings, record.error,
    ]));
    ...
    sheet['!cols'] = [
      ...
      { wch: 14 }, { wch: 12 }, { wch: 10 }, { wch: 12 }, { wch: 58 }, { wch: 58 },
    ];
