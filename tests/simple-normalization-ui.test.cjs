...
async function fixture(h,{badStandard=false,ambiguous=false,cloud=false,legacy=false,refreshFailsAfterSave=false}={}) {
  ...
  },{badStandard,ambiguous,cloud,legacy,refreshFailsAfterSave});
}
